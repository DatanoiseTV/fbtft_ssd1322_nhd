...
const s16 init[] = {			/* Initialization for NHD-2.7-12864WDW3 OLED display */
	...
	-1, 0xAB, 0x01,		/* Set start line position */
...
FBTFT_REGISTER_DRIVER(DRVNAME, "solomon,ssd1322_nhd", &display);

MODULE_ALIAS("spi:" DRVNAME);
MODULE_ALIAS("platform:" DRVNAME);
MODULE_ALIAS("spi:ssd1322_nhd");
MODULE_ALIAS("platform:sssd1322_nhd");

MODULE_DESCRIPTION("NHD-2.7-12864WDW3 OLED Driver");
